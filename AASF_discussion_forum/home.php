...
<br><br>
<img src="aasf_banner.png" style="width: 100%; height: 25vw; border-radius: 1vw;">;
<br>
...
<br><br>
	<div style="font-family: 'Ubuntu'; font-size: 2vw;font-weight: bold;color: black;padding-left: 2vw;">
			Leaderboard</div><br>
			<div style="background-color: #e9164b; color:white;font-family:'Ubuntu';font-size: 16px; padding:1vw; border-radius: 0.8vw;width: 15vw;">
					<?php leaderboard(); ?>
			</div>
</div>
